...
class AppSettingsPatch(BaseModel): language: Literal["uk", "ru", "en"] | None = None; theme: Literal["dark", "light", "green", "violet"] | None = None; thread_count: int | None = Field(default=None, ge=1, le=64); compute_mode: Literal["auto", "cuda", "cpu"] | None = None; online_name: str | None = Field(default=None, max_length=40); songs_folder: str | None = Field(default=None, max_length=4096); ai_folder: str | None = Field(default=None, max_length=4096); cache_folder: str | None = Field(default=None, max_length=4096)


@router.get("/settings")
def get_settings() -> dict: return app_settings_service.read_settings()
...
def get_ui_preferences() -> dict[str, dict[str, Any]]: return app_settings_service.read_ui_preferences()
