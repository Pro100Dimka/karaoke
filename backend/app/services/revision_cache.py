"""Process-local cache for canonical song revisions.

Writers explicitly invalidate song entries after a successful mutation.  The
package service still verifies a cheap filesystem/runtime signature before
reusing a cached digest, so external changes are detected in normal cases too.
"""
