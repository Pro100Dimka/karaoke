...
set "MODEL_DIR=%~dp0backend\engines\game\models"
...
if exist "%MODEL_PATH%\config.json" (
  echo GAME model is already installed.
  exit /b 0
)

echo Downloading the GAME melody model. This is a one-time 345 MB download.
