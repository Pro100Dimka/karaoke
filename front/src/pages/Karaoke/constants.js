...
export const EFFECT_PRESETS = [
  ...
  { id: "pop", label: translateSaved("Поп"), symbol: "☆", reverb: 0.36, echo: 0.24, delay: 0.1 },
  { id: "rock", label: translateSaved("Рок"), symbol: "ϟ", reverb: 0.3, echo: 0.12, delay: 0.07 },
  { id: "club", label: translateSaved("Клуб"), symbol: "◎", reverb: 0.5, echo: 0.38, delay: 0.22 }
];
