...
const contracts = [
  [
    "Modal keeps stable lifecycle listeners",
  ...
  [
    "Dropdown listeners exist only while open",
    "src/components/fields/Dropdown.jsx",
    [
  ...
  [
    "app settings ignores stale reload responses",
    "src/contexts/app-settings.jsx",
    [
  ...
  [
    "Library uses centralized app settings",
  ...
  [
    "polling queues refreshes and supports hidden documents",
  ...
  [
    "settings writes share one queue",
  ...
  [
    "Karaoke follows route song changes",
    "src/pages/Karaoke/index.jsx",
    [/const songId = location\.state\?\.songId \|\| null;/],
    [/useState\(location\.state\?\.songId/]
  ],
  [
    "library delegates import, actions and room sync",
    "src/pages/Library/index.jsx",
    [
  ...
  [
    "song folder errors are handled",
    "src/pages/Library/hooks/use-song-actions.js",
    [
  ...
  [
    "remote library queries are event-driven",
    "src/pages/Library/hooks/use-room-sync.js",
    [
      /roomEventId/,
  ...
  [
    "online room modal guards duplicate joins",
    "src/components/OnlineRoomModal.jsx",
    [
  ...
  [
    "FieldInput forwards keyboard handlers",
    "src/components/fields/field-input.jsx",
    [/onKeyDown,/, /onKeyDown\n\s*\};/]
  ],
  [
    "mounted ref supports Strict Mode replay",
    "src/hooks/useMountedRef.js",
    [/mountedRef\.current = true/, /mountedRef\.current = false/]
  ],
  [
    "Electron backend restarts safely",
    "electron/main.cjs",
    [
...
multiSourceContract(
  ...
  (sources) => {
    ...
    assert.match(
      sources["src/components/OnlineRoomDock.jsx"],
...
const additionalContracts = [
  [
    "async guards share mounted state",
    "src/hooks/useAsyncQueue.js",
    [/useMountedRef/]
  ],
  [
    "exclusive actions share mounted state",
    "src/hooks/useExclusiveAsyncAction.js",
    [/useMountedRef/]
  ],
  [
    "audio settings serialize writes",
    "src/pages/Settings/audio-settings.jsx",
    [
      /useAsyncQueue/,
  ...
  [
    "Electron renderer uses sandbox isolation",
    "electron/main.cjs",
    [/contextIsolation:\s*true/, /nodeIntegration:\s*false/, /sandbox:\s*true/]
  ],
  [
    "renderer defines a restrictive CSP",
    "index.html",
    [
  ...
  [
    "late room audio failures are connection-aware",
    "src/contexts/OnlineRoomContext.jsx",
    [
      /audio\.play\(\)\.catch\(\(\) => \{\s*if \(!isCurrentConnection\(\)\) return;/
    ]
  ],
  [
    "room modal ignores late state updates",
    "src/components/OnlineRoomModal.jsx",
    [
  ...
  [
    "room copy timer is mount-aware",
    "src/components/OnlineRoomDock.jsx",
    [
  ...
  [
    "microphone updates are serialized",
    "src/pages/Karaoke/hooks/useMicrophoneSettings.js",
    [
      /useAsyncQueue/,
      /enqueueUpdate\(async \(\) =>/,
  ...
  [
    "audio routing ignores stale enumeration",
    "src/pages/Karaoke/hooks/useAudioOutputRouting.js",
    [
      /let active = true/,
      /if \(!active\) return/,
      /active = false/,
  ...
  [
    "performance deletion is mount-aware",
  ...
  [
    "Karaoke derives microphone level",
    "src/pages/Karaoke/index.jsx",
    [
  ...
  [
    "Karaoke media owns media elements",
    "src/pages/Karaoke/components/karaoke-media.jsx",
    [/<audio\b/, /<iframe\b/, /<video\b/]
  ],
  [
    "Karaoke stage owns visual content",
    "src/pages/Karaoke/components/karaoke-performance-stage/index.jsx",
    [/<MelodyRoll/, /<KaraokeLyricLine/]
  ],
  [
    "transport removes dead monitoring and rolls back playback",
    "src/pages/Karaoke/hooks/useKaraokeTransport.js",
    [
  ...
  [
    "song settings saves are exclusive",
    "src/pages/Library/modals/song-settings/index.jsx",
    [/useExclusiveAsyncAction/]
  ],
  [
    "room dock actions are exclusive",
    "src/components/OnlineRoomDock.jsx",
    [/useExclusiveAsyncAction/],
    [/document\.execCommand/]
  ],
  [
    "title bar consumes rejected IPC promises",
    "src/components/TitleBar.jsx",
    [
      /Promise\.resolve\(electronAPI\[action\]\?\.\(\)\)\.catch/,
      /invokeWindowAction\(electronAPI, id\)/
    ]
  ]
];
...
multiSourceContract(
  ...
  (sources) => {
    const emptyState = sources["src/pages/Karaoke/index.jsx"].match(
      /if \(!song\) \{([\s\S]*?)\n  \}\n  if \(song\.status/
    )?.[1];
